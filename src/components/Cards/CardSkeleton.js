  ...
  return (
    <div className="flex items-start gap-4 md:gap-5 py-4 md:py-5 border-b border-gray-100 dark:border-white/[0.07] animate-pulse">
      ...
      <div className="flex-1 min-w-0 space-y-2">
        {/* Date skeleton */}
        <div className="h-3 w-28 bg-gray-100 dark:bg-white/[0.06] rounded" />
        ...
        <div className="flex gap-1.5">
          <div className="h-4 w-14 bg-gray-100 dark:bg-white/[0.06] rounded-full" />
          <div className="h-4 w-10 bg-gray-100 dark:bg-white/[0.06] rounded-full" />
        </div>

        {/* Description skeleton - desktop only */}
        <div className="hidden md:block h-3 w-1/2 bg-gray-100 dark:bg-white/[0.06] rounded" />
      </div>
    </div>
  );
}
