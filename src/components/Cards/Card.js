...
export default function Card({
  ...
  const imageContainerClasses = imageStyle === "cover"
    ? "relative rounded-2xl overflow-hidden w-full h-48 md:h-full"
    : "relative rounded-2xl overflow-hidden flex items-center justify-center w-full h-48 md:h-full";

  return (
    <div className="grid grid-cols-1 md:grid-cols-[150px_1fr_150px] p-6 mt-8 relative bg-black/40 rounded-2xl overflow-hidden shadow-[0_10px_15px_-3px_rgba(0,0,0,0.45)] transition-all duration-200 text-white hover:-translate-y-2.5 hover:bg-[#3c2ea9]">
      ...
      <div className="flex items-center justify-center md:order-1">
        <div className="rounded-2xl justify-center text-center text-black bg-[#edf8eb] py-8 px-6 w-full md:w-auto">
